...
# ═══════════════════════════════════════════════════════════════════
# DRIVER CHECK + INSTALL GUIDANCE
# ═══════════════════════════════════════════════════════════════════
def check_driver():
    """Check if Brother driver is installed. Guide user if not."""
    if os.path.exists(PPD_PATH) and os.path.exists(FILTER_PATH):
        return True
  ...
  Or install via Homebrew (community formula):
     {DIM}brew install --cask brother-ql1100{X}  (if available)
""")
    return False
